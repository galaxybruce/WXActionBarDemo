 ...
 * 
 */
public class CustomAddActionProvider extends ActionProvider implements
	...
	public CustomAddActionProvider(Context context) {
		...
		customChooser.setTitle("拍照");
		list.add(customChooser);
		customChooser = new CustomChooser();
		customChooser.setIc_resource(R.drawable.actionbar_facefriend_icon);
		customChooser.setTitle("群聊");
		list.add(customChooser);
		customChooser = new CustomChooser();
		customChooser.setIc_resource(R.drawable.actionbar_particular_icon);
		customChooser.setTitle("我的微信");
		list.add(customChooser);
		customChooser = new CustomChooser();
		customChooser.setIc_resource(R.drawable.actionbar_search_icon);
		customChooser.setTitle("搜索");
		list.add(customChooser);
	...
	public View onCreateActionView() {
		...
		customChooserView
				.setExpandActivityOverflowButtonResource(R.drawable.actionbar_add_icon);
